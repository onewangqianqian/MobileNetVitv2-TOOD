...
model = dict(
    ...
    neck=dict(
        type='SSDNeck',
        in_channels=(128, 160),
        out_channels=(128, 160, 512, 256, 256, 128),
    ...
    bbox_head=dict(
        type='SSDHead',
        in_channels=(128, 160, 512, 256, 256, 128),
        num_classes=5,
        use_depthwise=True,
        norm_cfg=dict(type='BN', eps=0.001, momentum=0.03),
        act_cfg=dict(type='ReLU6'),
...
data_root = '/mnt/d/deeplearning/no_bur/cocolike_bur4_COCO/'
...
data = dict(
    ...
    train=dict(
        _delete_=True,
        type='ClassBalancedRepeatDataset',
        oversample_thr=0.05,
        times=5,
        dataset=dict(
            type=dataset_type,
