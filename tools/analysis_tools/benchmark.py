...
# python -m torch.distributed.launch --nproc_per_node=1 --master_port=29500 tools/analysis_tools/benchmark.py configs/yolo/yolov3_mobilenetv2_320_300e_coco.py workspace/yolov3/yolov3_mobile/latest.pth --launcher pytorch