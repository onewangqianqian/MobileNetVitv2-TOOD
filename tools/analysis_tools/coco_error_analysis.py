...
def main():
    ...
    parser.add_argument('--result', default='/mnt/d/deeplearning/no_bur/mmdetection/workspace/keshihua/mvit_iouloss_cb0.05/20230304_121619.log.json', help='result file (json format) path')
    parser.add_argument('--out_dir', default='/mnt/d/deeplearning/no_bur/mmdetection/workspace/keshihua/mvit_iouloss_cb0.05/error/', help='dir to save analyze result images')
    # parser.add_argument(
    #     '--ann',
    ...
    parser.add_argument(
        '--ann',
        default='/mnt/d/deeplearning/pili_up/deep-learning-for-image-processing/pytorch_object_detection/ssd/cocolike_bur4_COCO/annotations/instances_val2017.json',
        help='annotation file path')
    parser.add_argument(
