...
def parse_args():
    ...
    parser.add_argument('--config', default='/mnt/d/deeplearning/no_bur/mmdetection/configs/tood/tood_mvit_v2_cefpn_1x_coco_anchorfree_l6_1504.py')
    parser.add_argument('--prediction_path', default='/mnt/d/deeplearning/no_bur/mmdetection/workspace/task2/anchor_free_l6/best_bbox_mAP_epoch_211.pkl')
    parser.add_argument(
        '--save_dir', default='/mnt/d/deeplearning/no_bur/mmdetection/workspace/task2/anchor_free_l6/keshihua/confusion_matrix/',help='directory where confusion matrix will be saved')
    parser.add_argument(
...
def plot_confusion_matrix(confusion_matrix,
    ...
    fig, ax = plt.subplots(
        figsize=(0.5 * 10 * num_classes, 0.5 * 10 * num_classes * 0.8), dpi=180)
    cmap = plt.get_cmap(color_theme)
    im = ax.imshow(confusion_matrix, cmap=cmap)
    plt.colorbar(mappable=im, ax=ax)

    title_font = {'weight': 'bold', 'size': 12*4}
    ax.set_title(title, fontdict=title_font)
    label_font = {'size': 10*4}
