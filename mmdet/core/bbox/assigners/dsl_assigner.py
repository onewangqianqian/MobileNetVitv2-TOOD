...
class DynamicSoftLabelAssigner(BaseAssigner):
    ...
    def assign(
        ...
        """
        # print('pred_scores:', pred_scores.shape) #torch.Size([2125, 5])
        # print(priors.shape) # torch.Size([2125, 4])
        # print(decoded_bboxes.shape) # torch.Size([2125, 4])
        # print(gt_labels.shape) # torch.Size([1])
        # print(gt_bboxes.shape) # torch.Size([1, 4])
        # assert 1 == 2, '1 不等于 2'
        ...
        # print(valid_pred_scores.shape) #torch.Size([9, 1, 5])
        # print(soft_label.shape) # torch.Size([9, 1, 5])
