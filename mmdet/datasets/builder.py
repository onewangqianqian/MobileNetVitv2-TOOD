...
def build_dataset(cfg, default_args=None):
    from .dataset_wrappers import (ClassBalancedDataset, ConcatDataset,
                                   ...
                                   ClassBalancedRepeatDataset, ClassBalancedRepeatMultiImageMixDataset)
    ...
    elif cfg['type'] == 'ClassBalancedRepeatDataset':
        dataset = ClassBalancedRepeatDataset(
            build_dataset(cfg['dataset'], default_args), cfg['oversample_thr'], cfg['times'])
    ...
    elif cfg['type'] == 'ClassBalancedRepeatMultiImageMixDataset':
        cp_cfg = copy.deepcopy(cfg)
        cp_cfg['dataset'] = build_dataset(cp_cfg['dataset'])
        cp_cfg.pop('type')
        dataset = ClassBalancedRepeatMultiImageMixDataset(**cp_cfg)
