...
class MobileViTBlock(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        patches, info_dict = self.unfolding(fm) # patches [BP, N , C]
...
class MobileViT(BaseModule):
    ...
    mobilevit_arch_settings=[[4, 96, 144, 288, 2, 2, 2, 2, 4],
                             [4, 128, 192, 384, 4, 2, 2, 2, 4],
                             [4, 160, 240, 480, 3, 2, 2, 2, 4]]
    ...
    def forward(self, x):
        ...
        # outs1.shape: torch.Size([4, 128, 20, 20])
        # outs2.shape: torch.Size([4, 160, 10, 10])
        # assert 1==2
        return tuple(outs)
